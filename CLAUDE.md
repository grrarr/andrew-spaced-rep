# Andrew Spaced Rep — Claude Code Context

## What this is

A spaced repetition tracker for math problems that Andrew wants to practice. Single HTML file hosted on GitHub Pages. Forked from the fufu-spaced-rep codebase but with completely separate questions and storage.

**App URL**: https://grrarr.github.io/andrew-spaced-rep/
**Repo**: https://github.com/grrarr/andrew-spaced-rep
...
1. Andrew describes a topic/problem
...
```js
{
  ...
  notes: "Why this was added, what concept it tests.",
...
- Storage keys (DO NOT CHANGE): `andrew-spaced-rep-v1`, `andrew-spaced-rep-v1-backup`, `andrew-last-exported`
...
- **At the start of every session, display the app URL**: https://grrarr.github.io/andrew-spaced-rep/
